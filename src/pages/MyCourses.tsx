...
const coursesData: Course[] = [
  ...
  },
  {
    ...
    rating: 4.9,
    students: 1450,
    image: 'https://images.unsplash.com/photo-1635372722656-389f87b941b7?w=400&h=300&fit=crop',
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-8">
              <div className="flex-shrink-0">
                <img src="/lovable-uploads/85c8aee4-1034-4b5c-acb9-886f5309cc3d.png" alt="SharmaJEE" className="h-8 w-auto" />
              </div>
              <div className="hidden md:flex space-x-8">
                <a href="#" className="text-gray-900 hover:text-blue-600 font-medium">Home</a>
                <a href="#" className="text-gray-900 hover:text-blue-600 font-medium">About Us</a>
                <a href="#" className="text-blue-600 font-medium">Courses</a>
                <a href="#" className="text-gray-900 hover:text-blue-600 font-medium">Results</a>
                <a href="#" className="text-gray-900 hover:text-blue-600 font-medium">Testimonials</a>
                <a href="#" className="text-gray-900 hover:text-blue-600 font-medium">FAQ</a>
              </div>
            </div>
